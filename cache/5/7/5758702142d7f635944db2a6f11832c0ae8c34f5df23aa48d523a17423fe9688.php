...
/* admin/video/listar.html */
class __TwigTemplate_5758702142d7f635944db2a6f11832c0ae8c34f5df23aa48d523a17423fe9688 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("./admin/layout.html", "admin/video/listar.html", 1);
        $this->blocks = array(
...
\t\t\t<div id=\"limitar-registros\" data-url=\"admin/painel/video\">
...
\t\t\t\t\t\t<td>";
                // line 46
                echo twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('cortarTexto')->getCallable(), array($this->getAttribute($this->getAttribute($context["video"], "getPost", array(), "method"), "getTitulo", array(), "method"), 80, true)), "html", null, true);
                echo "</td>
\t\t\t\t\t\t<td>";
                // line 47
...
\t\t\t\t\t\t<td>";
                // line 50
                echo ((($this->getAttribute($this->getAttribute($context["video"], "getPost", array(), "method"), "getDestaque", array(), "method") == 1)) ? ("Sim") : ("Não"));
                echo "</td>
\t\t\t\t\t\t<td>";
                // line 51
...
";
    ...
    {
        return "admin/video/listar.html";
    }
